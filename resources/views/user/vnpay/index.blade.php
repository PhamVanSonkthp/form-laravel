...
@section('content')
    ...
    @php
        ...
        $vnp_TmnCode = "KAB3S1MN"; //Website ID in VNPAY System
        $vnp_HashSecret = "DYORHUYVXIEEPILXXYDSUEOZKZVONFGJ"; //Secret key
        $vnp_Url = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
        //$vnp_Returnurl = "http://localhost/vnpay_php/vnpay_return.php";
        $vnp_Returnurl = "https://linhkienlaptop24h.com/";
    ...
    <form action="/vnpay/vnpay_create_payment" id="create_form" method="post">
        @csrf
