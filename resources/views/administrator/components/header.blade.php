...
{{--                                        stroke="#130F26" stroke-width="1.5" stroke-linecap="round"--}}
{{--                                        stroke-linejoin="round"></path>--}}
{{--                                    <path d="M13 10.5H15.773" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"--}}
{{--                                          stroke-linejoin="round"></path>--}}
{{--                                    <path fill-rule="evenodd" clip-rule="evenodd"--}}
...
{{--                                          fill="#130F26" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"--}}
{{--                                          stroke-linejoin="round"></path>--}}
{{--                                    <path fill-rule="evenodd" clip-rule="evenodd"--}}
...
{{--                            <li>--}}
{{--                                <div class="media"><img class="img-fluid b-r-5 me-3 img-50"--}}
...
{{--                                            <input class="count" type="text" name="qty" value="3"><span class="minus"><i--}}
{{--                                                    class="fa fa-minus"></i></span>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                    <div class="close-circle"><a href="#"><i class="me-1" data-feather="edit"></i></a><a--}}
{{--                                            href="#"><i data-feather="trash-2"></i></a></div>--}}
{{--                                </div>--}}
{{--                            </li>--}}
{{--                            <li>--}}
{{--                                <div class="media"><img class="img-fluid b-r-5 me-3 img-50"--}}
{{--                                                        src="../assets/images/product-4.png" alt="">--}}
{{--                                    <div class="media-body">--}}
...
{{--                                <h4 class="mb-0 f-w-700">Total : <span>$100.00</span></h4><a--}}
{{--                                    class="btn btn-primary view-checkout" href="checkout.html">Checkout</a>--}}
{{--                            </li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
{{--                </li>--}}
...
{{--                                                        <h5 class="mt-2"><a href="datatable-basic-init.html">Tables</a>--}}
{{--                                                        </h5>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </li>--}}
{{--                                        <li class="text-center"><a class="flip-btn btn btn-primary" id="flip-btn"--}}
