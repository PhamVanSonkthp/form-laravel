...
class MakeViewSearch extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:viewsearch {name}';
...
//        $path = $this->getPath("/Models/".str_replace("Repository","",$this->repositoryClass));
        $path = base_path() . '/resources/views/administrator/'.str_replace("repository","",strtolower($this->repositoryClass)) . "/search.blade.php";
...
//        return app_path() . '/Models/Repository.stub';
        return base_path(). '/stubs/make_view_search.stub';
    }
