...
class OpportunityCategoryController extends Controller
{
    ...
    public function __construct(OpportunityCategory $model)
    {
    ...
    public function audit(Request $request, $id)
    {
        ...
        $items = $auditModel->searchByQuery($request, ['auditable_id' => $id, 'auditable_type' => 'App\Models\OpportunityCategory'], null, null, true);
